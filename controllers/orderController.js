...
/**
 * Grąžina užsakymą pagal ID (tik jei vartotojas yra admin)
 */
...
/**
 * Grąžina visus konkretaus vartotojo užsakymus (admin arba pačio vartotojo)
 */
...
/**
 * Grąžina visus sistemos užsakymus (tik admin)
 */
...
/**
 * Atnaujina užsakymo statusą (tik admin)
 */
...
/**
 * Ištrina užsakymą pagal ID (tik admin)
 */
...
/**
 * Grąžina konkretų prisijungusio vartotojo užsakymą pagal ID
 */
...
/**
 * Papildoma checkout alternatyva – su sumos tikrinimu (naudojama, jei skaičiavimai vykdomi front-end)
 */
